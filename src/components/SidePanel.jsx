        ...
        <div className="flex flex-col gap-2">
...

            {
                Object.entries(data?.list[0]?.components).map(([key, value]) => {
                    ...
                    return (
                        <div key={key} className="rounded-lg bg-linear-to-tr dark:from-sidebar from-sidebar-primary to-sidebar-accent p-2 flex flex-col gap-2 animate-[fade-in_2s_ease-in-out_forwards]">
